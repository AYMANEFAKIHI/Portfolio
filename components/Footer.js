      ...
      <div className="container-max section-padding">
        ...
        >
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold gradient-text mb-4">Aymane Fakihi</h3>
            <p className="text-gray-400 mb-4 max-w-md">
              Full-stack developer passionate about creating beautiful, functional web applications
              that solve real-world problems.
            </p>
            <div className="flex space-x-4">
              {/* Removed Twitter and Pinterest icons */}
              <motion.a
                href="https://www.linkedin.com/in/aymane-fakihi-9a3435335/"
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-[#3498db] transition-colors duration-300"
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index}>
                  <a
                    href={link.href}
                    className="text-gray-400 hover:text-[#1abc9c] transition-colors duration-300"
                  >
                    {link.name}
                  </a>
                </li>
